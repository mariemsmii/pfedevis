...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/pfestorefront/electronics/en",
						"https://electronics.local:9002/pfestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/pfestorefront/electronics/en",
						"https://electronics.local:9002/pfestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/pfestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/pfestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/pfestorefront/electronics/en",
						"https://electronics.local:9002/pfestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/pfestorefront",
						"https://electronics.local:9002/pfestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/pfestorefront",
						"https://electronics.local:9002/pfestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/pfestorefront/electronics/en",
						"https://electronics.local:9002/pfestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
