 ...
 */
package fr.decade.pfe.fulfilmentprocess.test.jobs;
...
import fr.decade.pfe.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = PfeFulfilmentProcessConstants.ORDER_PROCESS_NAME;
