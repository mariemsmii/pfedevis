...
import fr.decade.pfe.fulfilmentprocess.actions.order.SendAuthorizationFailedNotificationAction;
...
public class SendAuthorizationFailedNotificationTest
{
	...
	/**
	 * Test method for
	 * {@link fr.decade.pfe.fulfilmentprocess.actions.order.SendOrderPlacedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
