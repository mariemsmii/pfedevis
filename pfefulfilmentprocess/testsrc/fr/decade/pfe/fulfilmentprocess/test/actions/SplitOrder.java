 ...
 */
package fr.decade.pfe.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(PfeFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(PfeFulfilmentProcessConstants.PARENT_PROCESS);
