 ...
 */
package fr.decade.pfe.test.setup;
...
import fr.decade.pfe.test.constants.PfeTestConstants;
import fr.decade.pfe.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = PfeTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/pfetest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/pfetest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/pfetest/import/cstickets.impex");
			...
			importImpexFile(context, "/pfetest/import/csquotes.impex");
		}
	}
}
