...
public class DefaultPfeservicesService implements PfeservicesService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultPfeservicesService.class);
	...
	{
		return DefaultPfeservicesService.class.getResourceAsStream("/pfeservices/sap-hybris-platform.png");
	}
